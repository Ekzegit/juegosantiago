          ...
          <div class="col-lg-8">
            <div>
              <div class="slide-one-item home-slider owl-carousel">
                <div><img src="images/plazablanda1.jpg" alt="Image" class="img-fluid"></div>
                <div><img src="images/plazablanda2.jpg" alt="Image" class="img-fluid"></div>
              </div>
            </div>
            <div class="bg-white property-body border-bottom border-left border-right">
              <div class="row mb-5">
                <div class="col-md-6">
                  <strong class="text-success h1 mb-3">$ 35.000</strong>
                </div>
                <div class="col-md-6">
              ...
              <h2 class="h4 text-black">PLAZA BLANDA</h2>
