          ...
          <div class="col-lg-8">
            <div>
              <div class="slide-one-item home-slider owl-carousel">
                <div><img src="images/web7.jpg" alt="Image" class="img-fluid"></div>
                <div><img src="images/mini2.jpg" alt="Image" class="img-fluid"></div>
              </div>
            </div>
            <div class="bg-white property-body border-bottom border-left border-right">
              <div class="row mb-5">
                <div class="col-md-6">
                  <strong class="text-success h1 mb-3">$ 25.000 / 32.000 </strong><span>(con pelotas)</span>
                </div>
                <div class="col-md-6">
              ...
              <h2 class="h4 text-black"> MINI TOBOGAN</h2>
