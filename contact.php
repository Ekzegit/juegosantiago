      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form action="sendmail.php" method="POST" class="p-5 bg-white border">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="mensaje" id="mensaje" cols="30" rows="5" class="form-control" placeholder="Escribe tu mensaje."></textarea>
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              <h3 class="h6 text-black mb-3 text-uppercase">Informacion de Contacto</h3>
              <p class="mb-0 font-weight-bold">Direccion</p>
              <p class="mb-4">Parina 9595, La florida, Chile.</p>

              <p class="mb-0 font-weight-bold">Telefono</p>
              <p class="mb-4"><a href="tel:+56973783768">+56973783768</a></p>

              <p class="mb-0 font-weight-bold">Email</p>
              <p class="mb-0"><a href="mailto:contacto@juegosinflablesantiago.cl">contacto@juegosinflablesantiago.cl</a></p>
