      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            <div>
              <div class="slide-one-item home-slider owl-carousel">
                <div><img src="images/multi1.jpg" alt="Image" class="img-fluid"></div>
                <div><img src="images/multi2.jpg" alt="Image" class="img-fluid"></div>
                <div><img src="images/multi3.jpg" alt="Image" class="img-fluid"></div>
                <div><img src="images/multi4.jpg" alt="Image" class="img-fluid"></div>
              </div>
            </div>
            <div class="bg-white property-body border-bottom border-left border-right">
              <div class="row mb-5">
                <div class="col-md-6">
                  <strong class="text-success h1 mb-3">$ 30.000</strong>
                </div>
                <div class="col-md-6">
              ...
              <h2 class="h4 text-black">MULTIPROPOSITO</h2>
          ...
          <div class="col-lg-4">
            ...
            <h3 class="h4 text-black widget-title mb-3">Pide tu reserva!</h3>
              <form action="sendemail.php" class="form-contact-agent" method="POST">
                ...
                <div class="form-group">
                  <label for="fecha">Fecha arriendo:</label>
                  <input type="date" id="fecha" name="fecha" min="<?php $hoy=date("Y-m-d"); echo $hoy;?>" max="2021-12-31"  placeholder="AA-MM-DD" required>
                </div>
                <div class="form-group">
                  ...
                  <select name="modelo" required>
                    ...
                    <option>Doble Tobogan</option>

                    <option>Tobogan</option>

                    <option>Multiproposito</option>

                    <option>Escalada</option>

                    <option>Mini Tobogan</option>

                    <option>Plaza Blanda</option>
            ...
            <div class="bg-white widget border rounded">
              <h3 class="h4 text-black widget-title mb-3">Condiciones de arriendo</h3>
              <p>Descarga las condiciones y reglamento sobre los juegos.</p>
              <a href="pdf/Lo que debes saber antes de arrendar.pdf" download="Lo que debes saber antes de arrendar.pdf">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100">
              ...
              <div class="p-4 property-body">
                ...
                <li>
                    <span class="property-specs">Capacidad</span>
                    <span class="property-specs-number">8 niños</span>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100">
              ...
              <div class="p-4 property-body">
                ...
                <li>
                    <span class="property-specs">Capacidad</span>
                    <span class="property-specs-number">6 niños</span>
                    
                  </li>
                  <li>
                    <span class="property-specs">Edad</span>
                    <span class="property-specs-number">desde 3 hasta 6 años</span>
          ...
          <div class="property-entry h-100">
              ...
              <div class="p-4 property-body">
                ...
                <li>
                    <span class="property-specs">Capacidad</span>
                    <span class="property-specs-number">13 niños</span>
